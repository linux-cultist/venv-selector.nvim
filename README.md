<p align="center">
  <h1 align="center">🎉 Python Venv Selector</h2>
</p>
...
Here is an example of _replacing_ the default cwd search with one that **doesnt** search for hidden files. It replaces the cwd search since its named `cwd`.
