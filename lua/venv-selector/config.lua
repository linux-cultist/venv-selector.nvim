...
function M.merge_user_settings(user_settings)
    ...
    M.default_settings = vim.tbl_deep_extend('force', M.default_settings, user_settings.settings or {})

    M.default_settings.detected = {
        system = vim.loop.os_uname().sysname,
    }
    log.debug('Complete user settings:', M.default_settings, '')
end
