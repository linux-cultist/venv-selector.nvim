    ...
    local systems = {
        ...
        ['Windows_NT'] = function()
            return {
                ...
                cwd = {
                    command = "$FD --fixed-strings Scripts\\python.exe$ $CWD --full-path --color never -HI -a",
                },
                workspace = {
                    command = "$FD --fixed-strings Scripts\\python.exe$ $WORKSPACE_PATH --full-path --color never -HI -a",
                },
                file = {
                    command = "$FD --fixed-strings Scripts\\python.exe$ $FILE_PATH --full-path --color never -HI -a",
                }
