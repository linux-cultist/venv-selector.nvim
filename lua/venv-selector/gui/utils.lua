...
--
-- Shared helper functions for all picker backends.
-- Canonical shared types live in lua/venv-selector/types.lua.
...
---Sort results (in-place) for consistent UX across pickers.
---@param results venv-selector.SearchResult[]
